(function(){
    ...
    var mobileTag = "<script async src='https://securepubads.g.doubleclick.net/tag/js/gpt.js'></script><div id='gpt-passback'><script>window.googletag = window.googletag || {cmd: []};googletag.cmd.push(function() {googletag.defineSlot('/21710144538/Pushdown-320x50', [320, 50], 'gpt-passback').addService(googletag.pubads()).setClickUrl('%%CLICK_URL_UNESC%%');googletag.pubads().set('page_url', 'streamlyn.com');googletag.enableServices();googletag.display('gpt-passback');});</script></div>"
    ...
    function insertAd(){
            ...
            div.style.marginLeft = (window.innerWidth - mobileAdDimensions[0])/2 + "px";
            div.style.zIndex = "0";
            ...
            iframe.setAttribute('src', mobileTag);//'about:blank');
            ...
            setTimeout(() => {
                var open = setInterval(() => {
                    if(div.offsetHeight < mobileAdDimensions[1]){
