/*
	https://demo.bidsxchange.com/demo/qube.html
	https://demo.bidsxchange.com/demo/qube-mobile.html
	https://demo.bidsxchange.com/demo/qube-tab.html
*/
(function(){
	var data={};
	data.tags={};
	...
	data.width=300;
	data.height=250;
	data.tags.push('./images/300x250/300x250-1.png');
	data.tags.push('./images/300x250/300x250-2.png');
	data.tags.push('./images/300x250/300x250-3.png');
	data.tags.push('./images/300x250/300x250-4.png');
	/*
	data.tags['300x250'].push("<script src='https://www.googletagservices.com/tag/js/gpt.js'>googletag.pubads().definePassback('/21710144538/dp-streamlyncreativetype1-300x250', [300, 250]).display();</script>");
	data.tags['300x250'].push("<script src='https://www.googletagservices.com/tag/js/gpt.js'>googletag.pubads().definePassback('/21710144538/dp-streamlyncreativetype2300x250', [300, 250]).display();</script>");
	data.tags['300x250'].push("<script src='https://www.googletagservices.com/tag/js/gpt.js'>googletag.pubads().definePassback('/21710144538/dp-streamlyncreativetype3-300x250', [300, 250]).display();</script>");
	data.tags['300x250'].push("<script src='https://www.googletagservices.com/tag/js/gpt.js'>googletag.pubads().definePassback('/21710144538/dp-streamlyncreativetype4-300x250', [300, 250]).display();</script>");
	*/
				...
				function start() {
					setTimeout(function() {
						...
						function rotateFrom(rotateFromValue,rotateToValue) {
							var rotateValueX = rotateFromValue;
							var rotateValueY = 0;
							var rotateInterval=setInterval(function(){
								...
								data.cube.style.transition='all 1s ease-in-out';
								data.cube.style.webkitTransition='all 1s ease-in-out';
								data.cube.style.mozTransform='all 1s ease-in-out';
								if(data.size=='728x90') {
