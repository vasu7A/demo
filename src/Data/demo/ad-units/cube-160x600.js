/*
	https://demo.bidsxchange.com/demo/qube-160x600.html
*/
(function(){
	var data={};
	data.tags={};
	...
	data.width=160;
	data.height=600;
	data.tags.push('./images/160x600/160x600-1.png');
	data.tags.push('./images/160x600/160x600-2.png');
	data.tags.push('./images/160x600/160x600-3.png');
	data.tags.push('./images/160x600/160x600-4.png');
	/*
	data.tags['160x600'].push("<script src='https://www.googletagservices.com/tag/js/gpt.js'>googletag.pubads().definePassback('/21710144538/dp-streamlyncreativetype1-160x600', [160, 600]).display();</script>");
	data.tags['160x600'].push("<script src='https://www.googletagservices.com/tag/js/gpt.js'>googletag.pubads().definePassback('/21710144538/dp-streamlyncreativetype2-160x600', [160, 600]).display();</script>");
	data.tags['160x600'].push("<script src='https://www.googletagservices.com/tag/js/gpt.js'>googletag.pubads().definePassback('/21710144538/dp-streamlyncreativetype3-160x600', [160, 600]).display();</script>");
	data.tags['160x600'].push("<script src='https://www.googletagservices.com/tag/js/gpt.js'>googletag.pubads().definePassback('/21710144538/dp-streamlyncreativetype4-160x600', [160, 600]).display();</script>");
	*/
