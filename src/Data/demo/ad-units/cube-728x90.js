/*
	https://demo.bidsxchange.com/demo/qube-728x90.html
*/
(function(){
	var data={};
	data.tags={};
	...
	data.width=728;
	data.height=90;
	data.tags.push('./images/728x90/728x90-1.png');
	data.tags.push('./images/728x90/728x90-2.png');
	data.tags.push('./images/728x90/728x90-3.png');
	data.tags.push('./images/728x90/728x90-4.png');
	/*
	data.tags['728x90'].push("<script src='https://www.googletagservices.com/tag/js/gpt.js'>googletag.pubads().definePassback('/21710144538/dp-streamlyncreativetype1-728x90', [728, 90]).display();</script>");
	data.tags['728x90'].push("<script src='https://www.googletagservices.com/tag/js/gpt.js'>googletag.pubads().definePassback('/21710144538/dp-streamlyncreativetype2-728x90', [728, 90]).display();</script>");
	data.tags['728x90'].push("<script src='https://www.googletagservices.com/tag/js/gpt.js'>googletag.pubads().definePassback('/21710144538/dp-streamlyncreativetype3-728x90', [728, 90]).display();</script>");
	data.tags['728x90'].push("<script src='https://www.googletagservices.com/tag/js/gpt.js'>googletag.pubads().definePassback('/21710144538/dp-streamlyncreativetype4-728x90', [728, 90]).display();</script>");
	*/
	...
	try {
		(function(W,D){
			...
			data.adSlot.style.webkitTransformOrigin='0% 50%';
			data.adSlot.style.msTransformOrigin='0% 50%';
			data.adSlot.style.oTransformOrigin='0% 50%';
			data.adSlot.style.transformOrigin='0% 50%';
