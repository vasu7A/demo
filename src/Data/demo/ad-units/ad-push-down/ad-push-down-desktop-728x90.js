...
var mobileTag =  "<script async src='https://securepubads.g.doubleclick.net/tag/js/gpt.js'></script><div id='gpt-passback'><script>;window.googletag=window.googletag||{cmd:[]};googletag.cmd.push(function(){googletag.defineSlot('/21674279164/sl-standard-banners-3',[728,90],'gpt-passback').addService(googletag.pubads());googletag.enableServices();googletag.display('gpt-passback')});</script></div>"
    ...
    function insertAd(){
        ...
        xButton.onclick = function(){
            ...
            div.style.width = desktopAdDimensions[0]+ 40 + "px";
            ...
            setTimeout(() => {
                var open = setInterval(() => {
                    if(mainDiv.offsetHeight < (parseInt(desktopAdDimensions[1]))){
                        ...
                        closeButton.style.height = mainDiv.offsetHeight + 5 + "px";
                        xButton.style.height = mainDiv.offsetHeight + 5 + "px";
                        brandSVGHeight = mainDiv.offsetHeight + 5
                        xButtonSVGHeight= mainDiv.offsetHeight + 5
